...
//import org.springframework.mvc.format.date-time=yyyy-MM-dd HH:mm:ss
...
public class BlogController {
    ...
    public String blogMain(Model model){
        ...
        Collections.sort(posts, Post.COMPARE_BY_PRIORITY);
    ...
    public String blogPostAdd(@RequestParam String title,
                              ...
                              Model model){
        Post post = new Post(title, anons, full_text, published_at, priority);
    ...
    public String blogPostUpdate(@PathVariable (value="id") long id,
        ...
        post.setPublished_at(published_at);
